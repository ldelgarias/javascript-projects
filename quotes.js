const localQuotes = [
    {
        "text": "Samadhi is the top of the Himalayas in Spiritual practice. Nirvakalpa samadhi - that's all the way up.",
        "author": "Rama"
      },
      {
      ...
      {
        "text": "The greatest miracle in your journey into light. And if you are fortunate enough, you will gain the consciousness in this lifetime to see all tings glow, to see that all things are really made up of light.",
        "author": "Rama"
      },
      {
      ...
      {
        "text": "Chill out. Life is hard work no matter what you do. There is always going to be pain. There is always going to be pleasure. But what is not always going to be there is balance, happiness. That's a personal decision.",
        "author": "Rama"
      },
      {
